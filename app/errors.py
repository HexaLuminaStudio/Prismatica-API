...
_ERROR_HTTP: dict[str, int] = {
    ...
    "PRICING_RULE_NOT_FOUND": 409,
    "PRICING_RULE_INVALID": 409,
    "PRICING_VERSION_NOT_FOUND": 404,
...
_ERROR_MESSAGE_CN: dict[str, str] = {
    ...
    "PRICING_RULE_NOT_FOUND": "该功能尚未配置价格",
    "PRICING_RULE_INVALID": "价格规则无效",
    "PRICING_VERSION_NOT_FOUND": "价格版本不存在",
    "AI_SERVICE_NOT_CONFIGURED": "平台 AI 服务尚未配置",
